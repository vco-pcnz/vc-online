<template>
  <div>
    <a-spin :spinning="pageLoading" size="large">
      <div v-if="tabData.length" class="flex header-static">
        <div class="item-content">
          <div class="item">
            <div class="line one"></div>
            <div class="info-content">
              <p>{{ t('当前余额') }}</p>
              <vco-number class="num" :value="1983109.22" :precision="2" :end="true"></vco-number>
              <div>
                <vco-number :value="1983109.22" color="#666666" size="fs_xs" :precision="2" :end="true"></vco-number>
                <span>{{ t('可用余额') }}</span>
              </div>
            </div>
          </div>
    ...
    .item-content {
      ...
      > .item {
        ...
        > .line {
          ...
          width: 6px;
          &.one {
            background-color: rgba(169, 173, 87, .7);
            border: 1px solid rgba(109, 123, 31, .5);
          }
          &.two {
      ...
      .chart-content {
        ...
        &::after {
          ...
          box-shadow: 0 5px 24px rgba(169, 173, 87, .5);
          position: absolute;
          top: 0;
          left: 0;
        }
