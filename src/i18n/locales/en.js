export default {
  ...
  "放款金额 {0},可用金额 {1},{2}超出金额 {3}。 超额金额超过 {4} 美元。请修改后重新提交。": "Drawdown amount <span>{0}</span>, {1} available amount <span>{2}</span>, excess amount <span>{3}</span>. The excess exceeds <span>{4}</span>. Please edit and submit again.",
  "周期开始时间": "Period start",
  "还款日": "Due Date",
  "周期天数": "Days",
