export default {
  ...
  "计息方式": "Interest calculation method",
  "还款日方式": "Repayment date method",
  "截至日期": "As of date",
  "本金": "Principal",
  "贷款利率": "Interest rate",
  "宽限期天数": "Grace (calendar days)",
  "上一个还款日期": "RR paid date",
  "最早未还款的还款日": "Earliest unpaid due",
  "最早的一个宽限期的最后一天": "Earliest unpaid grace ends",
  ...
  "累计产生的复利(未结)": "Accrued Overdue Charge (unsettled)",
  "累计产生的复利(已结)": "Capitalised Overdue Charge",
  "罚息利率Lendr": "Interest rate",
  "欠款金额Lendr": "Arrears amount",
  "存在{0}项设置的金额小于已使用的金额的数据，请检查": "There are {0} items with set amounts less than the used amounts. Please check",
  "放款金额 {0},可用金额 {1},超出金额 {2}。 超额金额超过 {3} 美元。请修改后重新提交。": 'Drawdown amount <span>{0}</span>, available amount <span>{1}</span>, excess amount <span>{2}</span>. The excess exceeds <span>{3}</span>. Please edit and submit again.',
  "放款金额 {0},{1} 剩余金额 {2},超额金额{3}。 超额金额超过 {4} 美元。请修改后重新提交。": "Drawdown amount <span>{0}</span>, {1} available amount <span>{2}</span>, excess amount <span>{3}</span>. The excess exceeds <span>{4}</span>. Please edit and submit again.",
  "周期开始时间": "Period start",
  "还款日": "Due Date",
  "周期天数": "Days",
  "还款日的利息部分": "Scheduled interest",
  "还款日的本金部分": "Scheduled principal",
  "计划还款金额": "Scheduled payment",
  "已还金额": "Paid amount",
  "最新还款时间": "Paid date",
  "状态": "Status",
  "剩余欠款": "Arrears",
  ...
  "生成offer草稿": "Generate offer draft",
  ...
  "激活": "Active",
  "编辑风险": "Edit risk",
  "风险信息不能为空": "Risk information is required",
  "归档时间": "Archived at",
  "确定要归档该风险吗？": "Are you sure you want to archive this risk?",
  "确定要重新激活该风险吗？": "Are you sure you want to reactivate this risk?",
  "确定要删除该风险吗？": "Are you sure you want to delete this risk?",
  "删除成功": "Deleted successfully",
  "创建合同模版": "Create contract template",
  "紧急管理": "Urgent Management",
  "风险": "Risk",
  "风险项目": "Risk Item",
  "风险等级": "Risk Level",
  "等级": "Level",
