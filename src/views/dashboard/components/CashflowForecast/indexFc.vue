<template>
  <div class="flex items-end title">
    ...
    <template v-else>
      <div class="flex-1 fs_2xl cursor-pointer">Cashflow forecast FC tools</div>
    </template>
...
const loadData = (val) => {
  ...
  const nextSearch = { ...searchForm.value, ...(val || {}), product_uuid: productStore.currentProduct, lender: props.lender, tools: 1 };
