<template>
  <div class="flex justify-between title mb-10">
    ...
    <SearchContent v-model:value="searchForm" :searchConfig="searchConfig" :open_hidden="true" downloadUrl="project/forecast/transactionsExport" @change="loadData"></SearchContent>
  </div>
