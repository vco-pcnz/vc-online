...
import MeterStat from '@/views/projects/discharge/components/MeterStat.vue';
import TableBlock from '@/views/projects/discharge/components/TableBlock.vue';
import Detail from '@/views/projects/discharge/components/Detail.vue';
