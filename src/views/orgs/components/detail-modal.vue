<template>
  <div>
    ...
    <a-modal :width="600" v-if="open" :open="open" :footer="null" @cancel="open = false" class="sys-form-content">
      <ul class="orgs-info">
        <li>
          ...
          <p>
            <span class="label">
              <i class="iconfont" :class="{ cer: detail?.name }">&#xe679;</i>
            </span>
        ...
        <li>
          ...
          <p>
            <span class="label">
              <i class="iconfont" :class="{ cer: detail?.email_ok }"> &#xe66f; </i>
              {{ t('邮箱') }}:
            </span>
          ...
          <p>
            <span class="label">
              <i class="iconfont" :class="{ cer: detail?.mobile_ok }">&#xe678;</i>
              {{ t('手机号') }}:
            </span>
