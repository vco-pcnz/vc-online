  ...
  <div>
    <a-spin :spinning="tempLoading" size="large">
      <div class="main-info-container">
        <process-header :step-data="processStepData" :current="7">
          <!-- <template #left>
...
<script setup>
  ...
  const { t } = useI18n();
  const { tempLoading, tempModule, currentId, queryError, simpleImage, processStepData } = useDynamicModule('seven');
</script>
