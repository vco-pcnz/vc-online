    ...
    <div class="left-content">
      <div class="block-item">
        <div class="flex justify-end gap-5">
          ...
          <a-button type="primary-line" shape="round" size="small">
            {{ t('生成临时借款人ID') }}
            <a-tooltip>
              <template #title>
        ...
        <div class="sys-form-content mt-5">
          <a-form ref="formRef" layout="vertical" :model="formState">
            <a-row :gutter="24">
              ...
              <a-col :span="24">
                <a-form-item :label="formState.borrower_type === 1 ? t('身份证号码') : t('公司编码')" name="borrower_id_num">
        ...
        <div class="flex mt-5 items-end gap-20 justify-between">
          ...
          <a-button type="dark" shape="round" class="big shadow bold uppercase">{{ t('下一步') }}</a-button>
        </div>
      </div>
    </div>
