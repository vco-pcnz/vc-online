    ...
    <a-modal :width="550" :open="visible" :title="t('拟关闭')" :getContainer="() => $refs.JournalRef" :maskClosable="false" :footer="false" @cancel="updateVisible(false)">
      <div class="content sys-form-content">
        <div class="input-item">
          ...
          <a-date-picker class="datePicker" inputReadOnly v-model:value="formState.date" :format="selectDateFormat()" valueFormat="YYYY-MM-DD" :showToday="false" :disabledDate="disabledDateFormat" />
        </div>
