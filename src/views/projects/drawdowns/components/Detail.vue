<template>
  ...
  <div class="detail">
    ...
    <div class="flex justify-center mt-3">
      <a-button @click="save" type="dark" class="big uppercase" :loading="loading"> Accept documents </a-button>
    </div>
    ...
    <div class="flex justify-center">
      <a-popconfirm title="Are you sure you want to decline the request?" okText="decline">
        ...
        <a-button @click="save" type="danger" size="small" shape="round" :loading="loading">decline request</a-button>
      </a-popconfirm>
    </div>
  </div>
</template>
