...
<script setup>
  ...
  const getProjectData = async () => {
    ...
    try {
      await toolsDetail(params).then(res => {
        hasLandAmount.value = Boolean(Number(res.land_amount || 0))
  ...
  const pageInit = async () => {
    uuid.value = props.pageUuid
    projectDetail.value = props.pageProjectDetail
    footerDataCol.value = props.pageFooterData
    easyModel.value = props.pageEasyModel
    buildAmount.value = props.pageBuildAmount
    borrowerEquity.value = props.pageBorrowerEquity
    hasLandAmount.value = Boolean(Number(props.pageProjectDetail.land_amount || 0))
