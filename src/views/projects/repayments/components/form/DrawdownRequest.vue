      ...
      <div class="content sys-form-content">
        <a-form ref="formRef" layout="vertical" :model="formState" :rules="formRules">
          <a-row :gutter="24">
            ...
            <a-col :span="projectDetail.product.code === 'vsl' ? 5 : 12">
            ...
            <a-col :span="7" v-if="projectDetail.product.code === 'vsl'">
              <a-form-item :label="t('还款分配')" name="re_type">
                <a-select v-model:value="formState.re_type" @change="typeChange">
